...
namespace CG
{
    class MainWindow : Window
    {
        ...
        private void GLInit(object sender, EventArgs args)
        {
            ...
            string vertexShaderSource = ReadFromRes(@"CGCourseWork.Shaders.shader.vert");
            ...
            string polygonNormalsGeometryShaderSource = ReadFromRes(@"CGCourseWork.Extansions.polygon_normals.geom");
            ...
            string fragmentShaderSource = ReadFromRes(@"CGCourseWork.Shaders.shader.frag");
